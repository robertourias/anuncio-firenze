      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-2 lg:gap-12 lg:px-8 lg:py-20">
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="#apartamento"
              className="inline-flex items-center justify-center rounded-full border-2 border-white/70 px-6 py-3.5 font-heading text-sm font-semibold text-white transition-colors hover:bg-white/10 sm:text-base"
            >
              Ver detalhes
            </a>
          </div>
